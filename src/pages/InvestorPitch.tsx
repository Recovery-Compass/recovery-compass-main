...
const InvestorPitch = () => {
  ...
  useEffect(() => {
    ...
    intervals.push(setInterval(() => {
      setCounters(prev => ({
        ...prev,
        affected: Math.min(prev.affected + 500000, 20000000)
      }));
    }, 50));
    ...
    intervals.push(setInterval(() => {
      setCounters(prev => ({
        ...prev,
        underserved: Math.min(prev.underserved + 2, 95)
      }));
    }, 30));
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl md:text-2xl text-moonlight/80 max-w-4xl mx-auto mb-12 leading-relaxed">
                Environmental Response Design™ removes barriers for the 19M Americans 
                with substance disorders who remain outside traditional treatment systems
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
              <Card className="bg-navy/60 border-bronze/30 backdrop-blur-sm relative overflow-hidden group">
                ...
                <CardHeader className="relative z-10">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <TrendingUp className="h-4 w-4 text-bronze/60" />
                  </div>
                  ...
                  <CardDescription className="text-moonlight/70">
                    Americans with Substance Disorders
                  </CardDescription>
                </CardHeader>
                <CardContent className="relative z-10">
                  <div className="text-sm text-moonlight/60">
                    CDC estimates • Growing 8% annually
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-navy/60 border-teal/30 backdrop-blur-sm relative overflow-hidden group">
                ...
                <CardHeader className="relative z-10">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <AlertTriangle className="h-4 w-4 text-teal/60" />
                  </div>
                  <CardTitle className="text-4xl font-black text-teal mb-2">
                    {counters.underserved}%
                  </CardTitle>
                  <CardDescription className="text-moonlight/70">
                    Currently Underserved by Traditional Systems
                  </CardDescription>
                </CardHeader>
                <CardContent className="relative z-10">
                  <div className="text-sm text-moonlight/60">
                    SAMHSA data • Treatment access gap
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-navy/60 border-gold/30 backdrop-blur-sm relative overflow-hidden group">
                ...
                <CardContent className="relative z-10">
                  <div className="text-sm text-moonlight/60">
                    Healthcare + Social costs annually
                  </div>
                </CardContent>
              </Card>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="text-sm">
                    ...
                    <div className="text-moonlight/60">68% rural counties lack treatment access</div>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="text-sm">
                    <div className="text-moonlight font-semibold">Proven Impact</div>
                    <div className="text-moonlight/60">Environmental design reduces barriers 75%</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center text-moonlight/50 text-sm">
              Due Diligence Materials • Technical Architecture • Financial Projections
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-moonlight/70 max-w-3xl mx-auto">
                Comprehensive due diligence materials for institutional investors
              </p>
            </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-moonlight/80 leading-relaxed">
                    The recovery market represents one of healthcare's largest inefficiencies. 
                    95% of people with substance disorders remain outside treatment systems due to 
                    environmental barriers, not lack of motivation.
                  </p>
                </div>
                <div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-moonlight/80 leading-relaxed">
                    ...
                    healthcare costs, improved outcomes, and expanded access to effective care.
                  </p>
                </div>
              </div>
            </div>
