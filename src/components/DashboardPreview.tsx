  ...
  return (
    <Card className={`bg-midnight-foundation/80 backdrop-blur border p-4 ${statusColors[status]}`}>
      <div className="text-center">
        <div className="text-2xl font-bold font-montserrat mb-1">{value}</div>
        <div className="text-sm text-moon-glow/70 font-montserrat">{label}</div>
      </div>
    </Card>
  );
};
    ...
    <div className="bg-midnight-foundation/50 rounded-lg p-8 max-w-5xl mx-auto border border-compass-gold/20">
      <div className="bg-black/50 p-4 rounded-t-lg border-b border-compass-gold/10 mb-6">
        <div className="flex justify-between items-center">
          <h3 className="text-moon-glow font-montserrat font-semibold">Healthcare Partner Transformation</h3>
          <span className="text-compass-gold text-sm font-montserrat">90-Day Results</span>
        </div>
      </div>
      ...
      <div className="compliance-progress bg-deep-ocean/40 rounded-lg p-6 mb-6">
        <div className="flex items-center justify-center gap-6">
          <div className="text-center">
            <div className="text-4xl font-black font-montserrat text-amber-400">72%</div>
            <div className="text-sm text-moon-glow/60">Initial</div>
          </div>
          <div className="text-compass-gold text-3xl">→</div>
          <div className="text-center">
            <div className="text-4xl font-black font-montserrat text-green-400">94%</div>
            <div className="text-sm text-moon-glow/60">Current</div>
          </div>
        </div>
        <div className="text-center mt-3">
          <div className="text-moon-glow font-montserrat font-semibold">Overall Compliance</div>
        </div>
      </div>
      ...
      <div className="text-center">
        <p className="text-moon-glow/50 text-xs font-montserrat italic">
