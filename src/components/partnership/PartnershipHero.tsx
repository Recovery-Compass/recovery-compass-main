      ...
      <div className="relative z-10 text-center px-8 max-w-7xl mx-auto">
        ...
        >
          <div className="flex flex-col items-center gap-6">
            ...
            />
            <span className="text-2xl font-inter font-semibold">Recovery Compass</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-6">
            <img 
              ...
              className="w-32 h-32 object-contain"
            />
            <span className="text-2xl font-inter font-semibold">First Day</span>
          </div>
        </motion.div>
        ...
        {/* Tagline */}
        <motion.p
          className="text-xl md:text-2xl font-inter text-gray-300 mb-16 max-w-4xl mx-auto leading-relaxed"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
